...
class NginxConfig(object):
    def __init__(self, type, nginxConfigDir, minVersion, untilVersion, verbose=False, unused=False, flags=None, usrSharePath=None, name=None, sslCertificate=None, sslKey=None, endpoint=None, additionalLocation=None, **ignored):
        ...
        self._additionalLocation = additionalLocation or ''
    ...
    def _updateConfig(self, services, typeConfig):
        ...
        additionalLocation = self._additionalLocation
        conf = StringIO()
